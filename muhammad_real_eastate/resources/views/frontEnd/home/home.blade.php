                    ...
                    <div id="tab-1" class="tab-pane fade show p-0 active">
                        <div class="row g-4">
                             ...
                             <div class="col-lg-4 col-md-6 wow fadeInUp" data-wow-delay="0.1s">
                                    ...
                                    <div class="p-4 pb-0">
                                        <h5 class="text-main mb-3">{{$property->price}}</h5>
                                        <a class="d-block h5 mb-2" href="">{{$property->title}}</a>
                                        <p><i class="fa fa-map-marker-alt text-main me-2"></i>{{$property->location}}</p>
                                    </div>
                                    <div class="d-flex border-top">
                                        <small class="flex-fill text-center border-end py-2"><i class="fa fa-ruler-combined text-main me-2"></i>{{$property->sqrfit}} Sqft</small>
                                        <small class="flex-fill text-center border-end py-2"><i class="fa fa-bed text-main me-2"></i> {{$property->bed}} Bed </small>
                                        <small class="flex-fill text-center py-2"><i class="fa fa-bath text-main me-2"></i> {{$property->bath}} Bath </small>
                                    </div>
                                </div>
